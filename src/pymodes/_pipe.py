...
class PipeDecoder:
    ...
    def decode(
        ...
        *,
        ...
        State tracking, pair matching, and eviction will land in
        subsequent Plan 4b tasks. The skeleton just delegates to
        Message.decode() and wraps corrupt input in an error dict.
        """
        _ = timestamp  # reserved for state tracking + pair matching
        self._stats["total"] += 1
